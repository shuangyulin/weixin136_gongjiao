<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="周边分类" prop="zhoubianfenlei">
          <el-input v-model="ruleForm.zhoubianfenlei" 
              placeholder="周边分类" clearable  :readonly="ro.zhoubianfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="周边分类" prop="zhoubianfenlei">
              <el-input v-model="ruleForm.zhoubianfenlei" 
                placeholder="周边分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhoubianfenlei'){
            this.ruleForm.zhoubianfenlei = obj[o];
	    this.ro.zhoubianfenlei = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhoubianfenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhoubianfenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
